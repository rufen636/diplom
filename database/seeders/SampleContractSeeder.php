...
class SampleContractSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('sample_contracts')->insert([
            ...
            'notes' => 'Базовый шаблон для физических лиц. Используется по умолчанию.',
            'signatures_block' => '9. ПОДПИСИ СТОРОН

ИСПОЛНИТЕЛЬ (Провайдер):                          ЗАКАЗЧИК (Клиент):
...
ИСПОЛНИТЕЛЬ (Провайдер):
ООО "Интернет-Провайдер"
Адрес: г. Минск, ул. Примерная, д. 1
УНП: 123456789
р/с: BY00XXXX12345678901234
в ОАО "Банк"
...
М.П.',
        ...
        DB::table('sample_contracts')->insert([
            ...
            'signatures_block' => 'ПОДПИСИ СТОРОН
