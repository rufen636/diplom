        ...
        <aside class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-center h-16 bg-[#416081]">
                    <h1 class="text-white text-xl font-bold">Менеджер</h1>
                </div>
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <button @click="toggleDocuments" class="nav-link w-full"><svg class="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
