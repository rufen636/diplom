            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    <Link
                        ...
                        class="nav-link"
                        :class="{ active: $page.url.startsWith('/accountant/dashboard') }"
                    >
                    ...
                    <Link
                        ...
                        class="nav-link"
                        :class="{ active: $page.url.startsWith('/accountant/contracts') }"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link
                        :href="route('accountant.tariffs.index')"
                        class="nav-link"
                        :class="{ active: $page.url.startsWith('/accountant/tariffs') }"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link
                        :href="route('accountant.settings.index')"
                        class="nav-link"
                        :class="{ active: $page.url.startsWith('/accountant/settings') }"
                    >
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
