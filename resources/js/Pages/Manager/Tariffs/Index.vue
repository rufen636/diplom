    ...
    <ManagerLayout title="Управление тарифами">
        <div class="card">
            ...
            <div class="page-toolbar">
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Список тарифов</h3>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr
                            v-for="(tariff, index) in tariffs.data"
                            :key="tariff.id"
                            class="hover:bg-gray-50"
                        >
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ tariffs.from ? tariffs.from + index : index + 1 }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-[#416081]">
                                    {{ tariff.name }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    :class="[
                                        ...
                                        tariff.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                    ]"
                                >
        ...
        >
            <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4" @click.stop>
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    <strong>{{ tariffToDelete?.name }}</strong>?
                </p>
