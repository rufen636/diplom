<template>
    <ManagerLayout title="Добавить договор">
        <div class="max-w-3xl">
            <div class="card">
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Создать новый договор</h3>
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Например: ДГ-2024-001"
                                required
                            />
                    ...
                    <div class="flex items-center justify-end space-x-3 mt-6">
                        ...
                        <button type="submit" class="btn-primary" :disabled="processing">
                            {{ processing ? 'Создание...' : 'Создать договор' }}
                        </button>
                    </div>
                </form>
            </div>
...
function submit() {
    ...
    form.post(route('manager.contracts.store'), {
        onFinish: () => {
