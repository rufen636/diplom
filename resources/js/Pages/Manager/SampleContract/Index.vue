    ...
    <ManagerLayout title="Управление шаблонами договоров">
        <div class="card">
            ...
            <div class="page-toolbar">
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Список шаблонов договоров</h3>
...
export default {
    ...
    computed:{
        paginationLinks() {
            if (!this.contractsData?.meta?.links) return [];

            return this.contractsData.meta.links.map(link => {
