<template>
    <ManagerLayout title="Добавить пользователя">
        <div class="max-w-2xl">
            <div class="card">
                <h3 class="text-xl font-semibold text-gray-800 mb-6">Создать нового пользователя</h3>
...
function submit() {
    ...
    form.post(route('manager.users.store'), {
        onFinish: () => {
