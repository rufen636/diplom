    ...
    <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-8 py-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-green-100 mt-1">Можно устанавливать услугу</p>
            </div>
        </div>
    </div>
    ...
    <div class="px-8 py-6">
        ...
        <div class="space-y-4">
            ...
            <div class="mt-4 p-3 bg-green-50 rounded-lg">
                <p class="text-sm text-green-800 font-medium">🔧 Действие: приступайте к установке услуги по договору {{ $billing->contract?->contract_number ?? '—' }}</p>
            </div>
        </div>
    </div>
</div>
