...
<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-white">🔍 Новая договор</h1>
                <p class="text-blue-100 mt-1">Требуется выставить счет</p>
            </div>
    ...
    <div class="px-8 py-6">
        ...
        <!-- Request Details -->
        <div class="space-y-4">
            <h2 class="text-lg font-semibold text-gray-800 border-b pb-2">Детали договора #{{ $contract->contract_number }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg md:col-span-2">
                    ...
                    <p class="text-gray-800">{{ $contract->description ?: 'Нет описания' }}</p>
                </div>
